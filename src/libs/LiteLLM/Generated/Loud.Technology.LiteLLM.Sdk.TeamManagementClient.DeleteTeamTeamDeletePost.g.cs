...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class TeamManagementClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_DeleteTeamTeamDeletePostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_DeleteTeamTeamDeletePostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_DeleteTeamTeamDeletePostSecurityRequirement0,
            };
        partial void PrepareDeleteTeamTeamDeletePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? litellmChangedBy,
            global::Loud.Technology.LiteLLM.Sdk.DeleteTeamRequest request);
        partial void PrepareDeleteTeamTeamDeletePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? litellmChangedBy,
            global::Loud.Technology.LiteLLM.Sdk.DeleteTeamRequest request);
        partial void ProcessDeleteTeamTeamDeletePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteTeamTeamDeletePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> DeleteTeamTeamDeletePostAsync(
        ...
        {
            var __response = await DeleteTeamTeamDeletePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> DeleteTeamTeamDeletePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteTeamTeamDeletePostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteTeamTeamDeletePostSecurityRequirements,
                operationName: "DeleteTeamTeamDeletePostAsync");
            ...
            if (litellmChangedBy != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteTeamTeamDeletePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteTeamTeamDeletePost",
                                methodName: "DeleteTeamTeamDeletePostAsync",
                                pathTemplate: "\"/team/delete\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteTeamTeamDeletePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteTeamTeamDeletePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> DeleteTeamTeamDeletePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.DeleteTeamRequest
            {
                TeamIds = teamIds,
            };

            return await DeleteTeamTeamDeletePostAsync(
                litellmChangedBy: litellmChangedBy,
                request: __request,
                requestOptions: requestOptions,
