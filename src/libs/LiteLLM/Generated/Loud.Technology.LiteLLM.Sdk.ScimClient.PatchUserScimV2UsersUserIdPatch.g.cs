...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class ScimClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_PatchUserScimV2UsersUserIdPatchSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_PatchUserScimV2UsersUserIdPatchSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_PatchUserScimV2UsersUserIdPatchSecurityRequirement0,
            };
        partial void PreparePatchUserScimV2UsersUserIdPatchArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string userId,
            ref string? feature,
            global::Loud.Technology.LiteLLM.Sdk.SCIMPatchOp request);
        partial void PreparePatchUserScimV2UsersUserIdPatchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string userId,
            string? feature,
            global::Loud.Technology.LiteLLM.Sdk.SCIMPatchOp request);
        partial void ProcessPatchUserScimV2UsersUserIdPatchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPatchUserScimV2UsersUserIdPatchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.SCIMUser> PatchUserScimV2UsersUserIdPatchAsync(
            string userId,
        ...
        {
            var __response = await PatchUserScimV2UsersUserIdPatchAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.SCIMUser>> PatchUserScimV2UsersUserIdPatchAsResponseAsync(
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePatchUserScimV2UsersUserIdPatchArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PatchUserScimV2UsersUserIdPatchSecurityRequirements,
                operationName: "PatchUserScimV2UsersUserIdPatchAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePatchUserScimV2UsersUserIdPatchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PatchUserScimV2UsersUserIdPatch",
                                methodName: "PatchUserScimV2UsersUserIdPatchAsync",
                                pathTemplate: "$\"/scim/v2/Users/{userId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPatchUserScimV2UsersUserIdPatchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPatchUserScimV2UsersUserIdPatchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.SCIMUser.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.SCIMUser>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.SCIMUser.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PatchUserScimV2UsersUserIdPatchAsync(
                userId: userId,
                feature: feature,
                request: __request,
                requestOptions: requestOptions,
