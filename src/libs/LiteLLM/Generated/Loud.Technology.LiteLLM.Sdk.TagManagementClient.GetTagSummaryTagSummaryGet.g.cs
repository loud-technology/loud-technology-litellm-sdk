...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class TagManagementClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_GetTagSummaryTagSummaryGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_GetTagSummaryTagSummaryGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_GetTagSummaryTagSummaryGetSecurityRequirement0,
            };
        partial void PrepareGetTagSummaryTagSummaryGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string startDate,
            ref string endDate,
            ref string? tagFilter,
            global::System.Collections.Generic.IList<string>? tagFilters);
        partial void PrepareGetTagSummaryTagSummaryGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? tagFilter,
            global::System.Collections.Generic.IList<string>? tagFilters);
        partial void ProcessGetTagSummaryTagSummaryGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTagSummaryTagSummaryGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.TagSummaryResponse> GetTagSummaryTagSummaryGetAsync(
            string startDate,
            string endDate,
        ...
        {
            var __response = await GetTagSummaryTagSummaryGetAsResponseAsync(
                startDate: startDate,
                endDate: endDate,
                tagFilter: tagFilter,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.TagSummaryResponse>> GetTagSummaryTagSummaryGetAsResponseAsync(
            string startDate,
            string endDate,
            string? tagFilter = default,
            global::System.Collections.Generic.IList<string>? tagFilters = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTagSummaryTagSummaryGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTagSummaryTagSummaryGetSecurityRequirements,
                operationName: "GetTagSummaryTagSummaryGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddRequiredParameter("start_date", startDate)
                                .AddRequiredParameter("end_date", endDate)
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTagSummaryTagSummaryGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetTagSummaryTagSummaryGet",
                                methodName: "GetTagSummaryTagSummaryGetAsync",
                                pathTemplate: "\"/tag/summary\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTagSummaryTagSummaryGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTagSummaryTagSummaryGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.TagSummaryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.TagSummaryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.TagSummaryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
