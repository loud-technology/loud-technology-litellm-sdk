...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class InternalUserManagementClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_NewUserUserNewPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_NewUserUserNewPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_NewUserUserNewPostSecurityRequirement0,
            };
        partial void PrepareNewUserUserNewPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Loud.Technology.LiteLLM.Sdk.NewUserRequest request);
        partial void PrepareNewUserUserNewPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Loud.Technology.LiteLLM.Sdk.NewUserRequest request);
        partial void ProcessNewUserUserNewPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessNewUserUserNewPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// <summary>
        /// New User<br/>
        /// Use this to create a new INTERNAL user with a budget.<br/>
        /// Internal Users can access LiteLLM Admin UI to make keys, request access to models.<br/>
        /// This creates a new user and generates a new api key for the new user. The new api key is returned.<br/>
        /// Returns user id, budget + new key.<br/>
        /// Parameters:<br/>
        ...
        /// - models: Optional[list] - Model_name's a user is allowed to call. (if empty, key is allowed to call all models). Set to ['no-default-models'] to block all model access. Restricting user to only team-based model access.<br/>
        ...
        /// - duration: Optional[str] - Duration for the key auto-created on `/user/new`. Default is None.<br/>
        /// - key_alias: Optional[str] - Alias for the key auto-created on `/user/new`. Default is None.<br/>
        /// - sso_user_id: Optional[str] - The id of the user in the SSO provider.<br/>
        ...
        /// - organizations: List[str] - List of organization id's the user is a member of<br/>
        /// - budget_limits: Optional[list] - List of concurrent budget windows for the user. Each window specifies a budget_limit, time_period, and optional budget_duration. Example - [{"budget_limit": 10.0, "time_period": "1d"}, {"budget_limit": 50.0, "time_period": "7d"}].<br/>
        /// Returns:<br/>
        /// - key: (str) The generated api key for the user<br/>
        /// - expires: (datetime) Datetime object for when key expires.<br/>
        /// - user_id: (str) Unique user id - used for tracking spend across multiple keys for same user id.<br/>
        /// - max_budget: (float|None) Max budget for given user.<br/>
        /// Usage Example <br/>
        /// ```shell<br/>
        ///  curl -X POST "http://localhost:4000/user/new"      -H "Content-Type: application/json"      -H "Authorization: Bearer sk-1234"      -d '{<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.NewUserResponse> NewUserUserNewPostAsync(

            global::Loud.Technology.LiteLLM.Sdk.NewUserRequest request,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await NewUserUserNewPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.NewUserResponse>> NewUserUserNewPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareNewUserUserNewPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_NewUserUserNewPostSecurityRequirements,
                operationName: "NewUserUserNewPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareNewUserUserNewPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "NewUserUserNewPost",
                                methodName: "NewUserUserNewPostAsync",
                                pathTemplate: "\"/user/new\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessNewUserUserNewPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessNewUserUserNewPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.NewUserResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.NewUserResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.NewUserResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.NewUserResponse> NewUserUserNewPostAsync(
            ...
            global::Loud.Technology.LiteLLM.Sdk.NewUserRequestUserRole2? userRole = default,
            ...
            bool? autoCreateKey = default,
            bool? sendInviteEmail = default,
            string? ssoUserId = default,
            global::System.Collections.Generic.IList<string>? organizations = default,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.NewUserRequest
            {
                KeyAlias = keyAlias,
                Duration = duration,
                Models = models,
            ...
            return await NewUserUserNewPostAsync(
                request: __request,
                requestOptions: requestOptions,
