...
{
    public partial class VertexAiPassThroughClient
    {


        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_VertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_VertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_VertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteSecurityRequirement0,
            };
        partial void PrepareVertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string endpoint);
        partial void PrepareVertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string endpoint);
        partial void ProcessVertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Vertex Discovery Proxy Route<br/>
        /// Call any vertex discovery endpoint using the proxy.<br/>
        /// Just use `{PROXY_BASE_URL}/vertex_ai/discovery/{endpoint:path}`<br/>
        ...
        public async global::System.Threading.Tasks.Task<string> VertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteAsync(
            string endpoint,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await VertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteAsResponseAsync(
                endpoint: endpoint,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> VertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteAsResponseAsync(
            string endpoint,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareVertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_VertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteSecurityRequirements,
                operationName: "VertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDelete",
                                methodName: "VertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteAsync",
                                pathTemplate: "$\"/vertex_ai/discovery/{endpoint}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVertexDiscoveryProxyRouteVertexAiDiscoveryEndpointDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
