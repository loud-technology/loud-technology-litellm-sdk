...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class HealthClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_HealthCheckHistoryEndpointHealthHistoryGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_HealthCheckHistoryEndpointHealthHistoryGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_HealthCheckHistoryEndpointHealthHistoryGetSecurityRequirement0,
            };
        partial void PrepareHealthCheckHistoryEndpointHealthHistoryGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? model,
            ref string? statusFilter,
            ref int? limit,
            ref int? offset);
        partial void PrepareHealthCheckHistoryEndpointHealthHistoryGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            int? offset);
        partial void ProcessHealthCheckHistoryEndpointHealthHistoryGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessHealthCheckHistoryEndpointHealthHistoryGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> HealthCheckHistoryEndpointHealthHistoryGetAsync(
        ...
        {
            var __response = await HealthCheckHistoryEndpointHealthHistoryGetAsResponseAsync(
                model: model,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> HealthCheckHistoryEndpointHealthHistoryGetAsResponseAsync(
            string? model = default,
            string? statusFilter = default,
            int? limit = default,
            int? offset = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareHealthCheckHistoryEndpointHealthHistoryGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_HealthCheckHistoryEndpointHealthHistoryGetSecurityRequirements,
                operationName: "HealthCheckHistoryEndpointHealthHistoryGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareHealthCheckHistoryEndpointHealthHistoryGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "HealthCheckHistoryEndpointHealthHistoryGet",
                                methodName: "HealthCheckHistoryEndpointHealthHistoryGetAsync",
                                pathTemplate: "\"/health/history\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessHealthCheckHistoryEndpointHealthHistoryGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessHealthCheckHistoryEndpointHealthHistoryGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
