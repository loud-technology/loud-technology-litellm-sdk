...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class PolicyEngineClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_ComparePolicyVersionsPoliciesCompareGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_ComparePolicyVersionsPoliciesCompareGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_ComparePolicyVersionsPoliciesCompareGetSecurityRequirement0,
            };
        partial void PrepareComparePolicyVersionsPoliciesCompareGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string versionA,
            ref string versionB);
        partial void PrepareComparePolicyVersionsPoliciesCompareGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string versionA,
            string versionB);
        partial void ProcessComparePolicyVersionsPoliciesCompareGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessComparePolicyVersionsPoliciesCompareGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.PolicyVersionCompareResponse> ComparePolicyVersionsPoliciesCompareGetAsync(
            string versionA,
            string versionB,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ComparePolicyVersionsPoliciesCompareGetAsResponseAsync(
                versionA: versionA,
                versionB: versionB,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.PolicyVersionCompareResponse>> ComparePolicyVersionsPoliciesCompareGetAsResponseAsync(
            string versionA,
            string versionB,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareComparePolicyVersionsPoliciesCompareGetArguments(
                httpClient: HttpClient,
                versionA: ref versionA,
                versionB: ref versionB);


            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_ComparePolicyVersionsPoliciesCompareGetSecurityRequirements,
                operationName: "ComparePolicyVersionsPoliciesCompareGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddRequiredParameter("version_a", versionA)
                                .AddRequiredParameter("version_b", versionB)
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareComparePolicyVersionsPoliciesCompareGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ComparePolicyVersionsPoliciesCompareGet",
                                methodName: "ComparePolicyVersionsPoliciesCompareGetAsync",
                                pathTemplate: "\"/policies/compare\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessComparePolicyVersionsPoliciesCompareGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessComparePolicyVersionsPoliciesCompareGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.PolicyVersionCompareResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.PolicyVersionCompareResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.PolicyVersionCompareResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
