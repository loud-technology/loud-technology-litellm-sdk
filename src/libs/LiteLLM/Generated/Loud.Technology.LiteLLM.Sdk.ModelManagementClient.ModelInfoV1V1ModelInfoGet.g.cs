...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class ModelManagementClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_ModelInfoV1V1ModelInfoGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_ModelInfoV1V1ModelInfoGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_ModelInfoV1V1ModelInfoGetSecurityRequirement0,
            };
        partial void PrepareModelInfoV1V1ModelInfoGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? litellmModelId,
            bool? includeTeamModels,
            ref string? teamId);
        partial void PrepareModelInfoV1V1ModelInfoGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? litellmModelId,
            bool? includeTeamModels,
            string? teamId);
        partial void ProcessModelInfoV1V1ModelInfoGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessModelInfoV1V1ModelInfoGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ModelInfoV1V1ModelInfoGetAsync(
        ...
        {
            var __response = await ModelInfoV1V1ModelInfoGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> ModelInfoV1V1ModelInfoGetAsResponseAsync(
            string? litellmModelId = default,
            bool? includeTeamModels = default,
            string? teamId = default,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareModelInfoV1V1ModelInfoGetArguments(
                httpClient: HttpClient,
                litellmModelId: ref litellmModelId,
                includeTeamModels: includeTeamModels,
                teamId: ref teamId);
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ModelInfoV1V1ModelInfoGetSecurityRequirements,
                operationName: "ModelInfoV1V1ModelInfoGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("litellm_model_id", litellmModelId)
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareModelInfoV1V1ModelInfoGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ModelInfoV1V1ModelInfoGet",
                                methodName: "ModelInfoV1V1ModelInfoGetAsync",
                                pathTemplate: "\"/v1/model/info\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessModelInfoV1V1ModelInfoGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessModelInfoV1V1ModelInfoGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
