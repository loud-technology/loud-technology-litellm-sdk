...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class A2aClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_GetAgentCardA2aAgentIdWellKnownAgentJsonGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_GetAgentCardA2aAgentIdWellKnownAgentJsonGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_GetAgentCardA2aAgentIdWellKnownAgentJsonGetSecurityRequirement0,
            };
        partial void PrepareGetAgentCardA2aAgentIdWellKnownAgentJsonGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string agentId);
        partial void PrepareGetAgentCardA2aAgentIdWellKnownAgentJsonGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string agentId);
        partial void ProcessGetAgentCardA2aAgentIdWellKnownAgentJsonGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAgentCardA2aAgentIdWellKnownAgentJsonGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> GetAgentCardA2aAgentIdWellKnownAgentJsonGetAsync(
            string agentId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetAgentCardA2aAgentIdWellKnownAgentJsonGetAsResponseAsync(
                agentId: agentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> GetAgentCardA2aAgentIdWellKnownAgentJsonGetAsResponseAsync(
            string agentId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAgentCardA2aAgentIdWellKnownAgentJsonGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAgentCardA2aAgentIdWellKnownAgentJsonGetSecurityRequirements,
                operationName: "GetAgentCardA2aAgentIdWellKnownAgentJsonGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAgentCardA2aAgentIdWellKnownAgentJsonGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetAgentCardA2aAgentIdWellKnownAgentJsonGet",
                                methodName: "GetAgentCardA2aAgentIdWellKnownAgentJsonGetAsync",
                                pathTemplate: "$\"/a2a/{agentId}/.well-known/agent.json\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAgentCardA2aAgentIdWellKnownAgentJsonGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAgentCardA2aAgentIdWellKnownAgentJsonGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
