...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class VectorStoresClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_VectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_VectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_VectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetSecurityRequirement0,
            };
        partial void PrepareVectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string vectorStoreId,
            ref string fileId);
        partial void PrepareVectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string vectorStoreId,
            string fileId);
        partial void ProcessVectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> VectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetAsync(
            string vectorStoreId,
            string fileId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await VectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> VectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetAsResponseAsync(
            string vectorStoreId,
            string fileId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareVectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_VectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetSecurityRequirements,
                operationName: "VectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGet",
                                methodName: "VectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVectorStoreFileRetrieveVectorStoresVectorStoreIdFilesFileIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
