...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class BudgetSpendTrackingClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_CalculateSpendSpendCalculatePostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_CalculateSpendSpendCalculatePostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_CalculateSpendSpendCalculatePostSecurityRequirement0,
            };
        partial void PrepareCalculateSpendSpendCalculatePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Loud.Technology.LiteLLM.Sdk.SpendCalculateRequest request);
        partial void PrepareCalculateSpendSpendCalculatePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Loud.Technology.LiteLLM.Sdk.SpendCalculateRequest request);
        partial void ProcessCalculateSpendSpendCalculatePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCalculateSpendSpendCalculatePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.CalculateSpendSpendCalculatePostResponse> CalculateSpendSpendCalculatePostAsync(

            global::Loud.Technology.LiteLLM.Sdk.SpendCalculateRequest request,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CalculateSpendSpendCalculatePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.CalculateSpendSpendCalculatePostResponse>> CalculateSpendSpendCalculatePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCalculateSpendSpendCalculatePostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CalculateSpendSpendCalculatePostSecurityRequirements,
                operationName: "CalculateSpendSpendCalculatePostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCalculateSpendSpendCalculatePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CalculateSpendSpendCalculatePost",
                                methodName: "CalculateSpendSpendCalculatePostAsync",
                                pathTemplate: "\"/spend/calculate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCalculateSpendSpendCalculatePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCalculateSpendSpendCalculatePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.CalculateSpendSpendCalculatePostResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.CalculateSpendSpendCalculatePostResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.CalculateSpendSpendCalculatePostResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.CalculateSpendSpendCalculatePostResponse> CalculateSpendSpendCalculatePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.SpendCalculateRequest
            {
                Model = model,
                Messages = messages,
            ...
            return await CalculateSpendSpendCalculatePostAsync(
                request: __request,
                requestOptions: requestOptions,
