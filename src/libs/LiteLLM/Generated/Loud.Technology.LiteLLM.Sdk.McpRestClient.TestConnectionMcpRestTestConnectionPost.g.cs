...
{
    public partial class McpRestClient
    {


        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_TestConnectionMcpRestTestConnectionPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_TestConnectionMcpRestTestConnectionPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_TestConnectionMcpRestTestConnectionPostSecurityRequirement0,
            };
        partial void PrepareTestConnectionMcpRestTestConnectionPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Loud.Technology.LiteLLM.Sdk.NewMCPServerRequest request);
        partial void PrepareTestConnectionMcpRestTestConnectionPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Loud.Technology.LiteLLM.Sdk.NewMCPServerRequest request);
        partial void ProcessTestConnectionMcpRestTestConnectionPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTestConnectionMcpRestTestConnectionPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> TestConnectionMcpRestTestConnectionPostAsync(

            global::Loud.Technology.LiteLLM.Sdk.NewMCPServerRequest request,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await TestConnectionMcpRestTestConnectionPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> TestConnectionMcpRestTestConnectionPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTestConnectionMcpRestTestConnectionPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TestConnectionMcpRestTestConnectionPostSecurityRequirements,
                operationName: "TestConnectionMcpRestTestConnectionPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTestConnectionMcpRestTestConnectionPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TestConnectionMcpRestTestConnectionPost",
                                methodName: "TestConnectionMcpRestTestConnectionPostAsync",
                                pathTemplate: "\"/mcp-rest/test/connection\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTestConnectionMcpRestTestConnectionPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTestConnectionMcpRestTestConnectionPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> TestConnectionMcpRestTestConnectionPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.NewMCPServerRequest
            {
                Alias = alias,
                ...
                AvailableOnPublicInternet = availableOnPublicInternet,
                ByokApiKeyHelpUrl = byokApiKeyHelpUrl,
                ByokDescription = byokDescription,
                Command = command,
            ...
            return await TestConnectionMcpRestTestConnectionPostAsync(
                request: __request,
                requestOptions: requestOptions,
