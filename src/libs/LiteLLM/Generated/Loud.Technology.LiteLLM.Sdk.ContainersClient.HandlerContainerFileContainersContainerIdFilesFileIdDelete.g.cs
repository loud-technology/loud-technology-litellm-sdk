...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class ContainersClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_HandlerContainerFileContainersContainerIdFilesFileIdDeleteSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_HandlerContainerFileContainersContainerIdFilesFileIdDeleteSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_HandlerContainerFileContainersContainerIdFilesFileIdDeleteSecurityRequirement0,
            };
        partial void PrepareHandlerContainerFileContainersContainerIdFilesFileIdDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string containerId,
            ref string fileId);
        partial void PrepareHandlerContainerFileContainersContainerIdFilesFileIdDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string containerId,
            string fileId);
        partial void ProcessHandlerContainerFileContainersContainerIdFilesFileIdDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessHandlerContainerFileContainersContainerIdFilesFileIdDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> HandlerContainerFileContainersContainerIdFilesFileIdDeleteAsync(
            string containerId,
            string fileId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await HandlerContainerFileContainersContainerIdFilesFileIdDeleteAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> HandlerContainerFileContainersContainerIdFilesFileIdDeleteAsResponseAsync(
            string containerId,
            string fileId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareHandlerContainerFileContainersContainerIdFilesFileIdDeleteArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_HandlerContainerFileContainersContainerIdFilesFileIdDeleteSecurityRequirements,
                operationName: "HandlerContainerFileContainersContainerIdFilesFileIdDeleteAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareHandlerContainerFileContainersContainerIdFilesFileIdDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "HandlerContainerFileContainersContainerIdFilesFileIdDelete",
                                methodName: "HandlerContainerFileContainersContainerIdFilesFileIdDeleteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessHandlerContainerFileContainersContainerIdFilesFileIdDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessHandlerContainerFileContainersContainerIdFilesFileIdDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
