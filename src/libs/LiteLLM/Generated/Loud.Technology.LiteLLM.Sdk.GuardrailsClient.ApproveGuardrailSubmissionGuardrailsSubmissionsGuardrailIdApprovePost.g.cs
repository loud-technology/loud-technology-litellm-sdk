...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class GuardrailsClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_ApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_ApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_ApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostSecurityRequirement0,
            };
        partial void PrepareApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string guardrailId);
        partial void PrepareApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string guardrailId);
        partial void ProcessApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Approve Guardrail Submission<br/>
        ...
        public async global::System.Threading.Tasks.Task<string> ApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostAsync(
            string guardrailId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> ApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostAsResponseAsync(
            string guardrailId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostSecurityRequirements,
                operationName: "ApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: $"/guardrails/submissions/{guardrailId}/approve",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePost",
                                methodName: "ApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostAsync",
                                pathTemplate: "$\"/guardrails/submissions/{guardrailId}/approve\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessApproveGuardrailSubmissionGuardrailsSubmissionsGuardrailIdApprovePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
