...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class ResponsesClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_CancelResponseOpenaiV1ResponsesResponseIdCancelPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_CancelResponseOpenaiV1ResponsesResponseIdCancelPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_CancelResponseOpenaiV1ResponsesResponseIdCancelPostSecurityRequirement0,
            };
        partial void PrepareCancelResponseOpenaiV1ResponsesResponseIdCancelPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string responseId);
        partial void PrepareCancelResponseOpenaiV1ResponsesResponseIdCancelPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string responseId);
        partial void ProcessCancelResponseOpenaiV1ResponsesResponseIdCancelPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCancelResponseOpenaiV1ResponsesResponseIdCancelPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// <summary>
        /// Cancel Response<br/>
        /// Cancel a response by ID.<br/>
        /// Supports both:<br/>
        /// - Polling IDs (litellm_poll_*): Cancels background response and updates status in Redis<br/>
        /// - Provider response IDs: Passes through to provider API<br/>
        /// Follows the OpenAI Responses API spec: https://platform.openai.com/docs/api-reference/responses/cancel<br/>
        /// ```bash<br/>
        /// # Cancel polling response<br/>
        /// curl -X POST http://localhost:4000/v1/responses/litellm_poll_abc123/cancel     -H "Authorization: Bearer sk-1234"<br/>
        /// # Cancel provider response<br/>
        /// curl -X POST http://localhost:4000/v1/responses/resp_abc123/cancel     -H "Authorization: Bearer sk-1234"<br/>
        /// ```
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<string> CancelResponseOpenaiV1ResponsesResponseIdCancelPostAsync(
            string responseId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CancelResponseOpenaiV1ResponsesResponseIdCancelPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> CancelResponseOpenaiV1ResponsesResponseIdCancelPostAsResponseAsync(
            string responseId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCancelResponseOpenaiV1ResponsesResponseIdCancelPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CancelResponseOpenaiV1ResponsesResponseIdCancelPostSecurityRequirements,
                operationName: "CancelResponseOpenaiV1ResponsesResponseIdCancelPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: $"/openai/v1/responses/{responseId}/cancel",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCancelResponseOpenaiV1ResponsesResponseIdCancelPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CancelResponseOpenaiV1ResponsesResponseIdCancelPost",
                                methodName: "CancelResponseOpenaiV1ResponsesResponseIdCancelPostAsync",
                                pathTemplate: "$\"/openai/v1/responses/{responseId}/cancel\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCancelResponseOpenaiV1ResponsesResponseIdCancelPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCancelResponseOpenaiV1ResponsesResponseIdCancelPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
