...
-   :material-package-variant:{ .lg .middle } **Ready for NuGet**

    ---

    Release builds include semantic versions, Source Link, XML documentation, assembly signing, and symbol packages.
...
- [NuGet package](https://www.nuget.org/packages/LiteLLM/)
