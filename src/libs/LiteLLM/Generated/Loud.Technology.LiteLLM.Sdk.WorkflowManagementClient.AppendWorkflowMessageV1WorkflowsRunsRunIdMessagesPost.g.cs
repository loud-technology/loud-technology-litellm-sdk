...
{
    public partial class WorkflowManagementClient
    {


        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_AppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_AppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_AppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostSecurityRequirement0,
            };
        partial void PrepareAppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string runId,
            global::Loud.Technology.LiteLLM.Sdk.WorkflowMessageCreateRequest request);
        partial void PrepareAppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string runId,
            global::Loud.Technology.LiteLLM.Sdk.WorkflowMessageCreateRequest request);
        partial void ProcessAppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> AppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostAsync(
            string runId,
        ...
        {
            var __response = await AppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostAsResponseAsync(
                runId: runId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> AppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostAsResponseAsync(
            string runId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostSecurityRequirements,
                operationName: "AppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: $"/v1/workflows/runs/{runId}/messages",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPost",
                                methodName: "AppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostAsync",
                                pathTemplate: "$\"/v1/workflows/runs/{runId}/messages\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> AppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.WorkflowMessageCreateRequest
            {
                Role = role,
                Content = content,
                SessionId = sessionId,
            ...
            return await AppendWorkflowMessageV1WorkflowsRunsRunIdMessagesPostAsync(
                runId: runId,
                request: __request,
                requestOptions: requestOptions,
