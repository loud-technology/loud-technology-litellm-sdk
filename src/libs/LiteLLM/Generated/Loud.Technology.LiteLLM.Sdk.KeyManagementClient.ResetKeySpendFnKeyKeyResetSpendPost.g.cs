...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class KeyManagementClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_ResetKeySpendFnKeyKeyResetSpendPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_ResetKeySpendFnKeyKeyResetSpendPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_ResetKeySpendFnKeyKeyResetSpendPostSecurityRequirement0,
            };
        partial void PrepareResetKeySpendFnKeyKeyResetSpendPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string key,
            ref string? litellmChangedBy,
            global::Loud.Technology.LiteLLM.Sdk.ResetSpendRequest request);
        partial void PrepareResetKeySpendFnKeyKeyResetSpendPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string key,
            string? litellmChangedBy,
            global::Loud.Technology.LiteLLM.Sdk.ResetSpendRequest request);
        partial void ProcessResetKeySpendFnKeyKeyResetSpendPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessResetKeySpendFnKeyKeyResetSpendPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ResetKeySpendFnKeyKeyResetSpendPostAsync(
            string key,
        ...
        {
            var __response = await ResetKeySpendFnKeyKeyResetSpendPostAsResponseAsync(
                key: key,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> ResetKeySpendFnKeyKeyResetSpendPostAsResponseAsync(
            string key,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareResetKeySpendFnKeyKeyResetSpendPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ResetKeySpendFnKeyKeyResetSpendPostSecurityRequirements,
                operationName: "ResetKeySpendFnKeyKeyResetSpendPostAsync");
            ...
            if (litellmChangedBy != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareResetKeySpendFnKeyKeyResetSpendPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ResetKeySpendFnKeyKeyResetSpendPost",
                                methodName: "ResetKeySpendFnKeyKeyResetSpendPostAsync",
                                pathTemplate: "$\"/key/{key}/reset_spend\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessResetKeySpendFnKeyKeyResetSpendPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessResetKeySpendFnKeyKeyResetSpendPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> ResetKeySpendFnKeyKeyResetSpendPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.ResetSpendRequest
            {
                ResetTo = resetTo,
            };

            return await ResetKeySpendFnKeyKeyResetSpendPostAsync(
                key: key,
                litellmChangedBy: litellmChangedBy,
                request: __request,
                requestOptions: requestOptions,
