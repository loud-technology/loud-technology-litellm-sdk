...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class GuardrailsClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_ListGuardrailSubmissionsGuardrailsSubmissionsGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_ListGuardrailSubmissionsGuardrailsSubmissionsGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_ListGuardrailSubmissionsGuardrailsSubmissionsGetSecurityRequirement0,
            };
        partial void PrepareListGuardrailSubmissionsGuardrailsSubmissionsGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? status,
            ref string? teamId,
            ref string? search);
        partial void PrepareListGuardrailSubmissionsGuardrailsSubmissionsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? status,
            string? teamId,
            string? search);
        partial void ProcessListGuardrailSubmissionsGuardrailsSubmissionsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListGuardrailSubmissionsGuardrailsSubmissionsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.ListGuardrailSubmissionsResponse> ListGuardrailSubmissionsGuardrailsSubmissionsGetAsync(
        ...
        {
            var __response = await ListGuardrailSubmissionsGuardrailsSubmissionsGetAsResponseAsync(
                status: status,
                teamId: teamId,
                search: search,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.ListGuardrailSubmissionsResponse>> ListGuardrailSubmissionsGuardrailsSubmissionsGetAsResponseAsync(
            string? status = default,
            string? teamId = default,
            string? search = default,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListGuardrailSubmissionsGuardrailsSubmissionsGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListGuardrailSubmissionsGuardrailsSubmissionsGetSecurityRequirements,
                operationName: "ListGuardrailSubmissionsGuardrailsSubmissionsGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListGuardrailSubmissionsGuardrailsSubmissionsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListGuardrailSubmissionsGuardrailsSubmissionsGet",
                                methodName: "ListGuardrailSubmissionsGuardrailsSubmissionsGetAsync",
                                pathTemplate: "\"/guardrails/submissions\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListGuardrailSubmissionsGuardrailsSubmissionsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListGuardrailSubmissionsGuardrailsSubmissionsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.ListGuardrailSubmissionsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.ListGuardrailSubmissionsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.ListGuardrailSubmissionsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
