...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class GuardrailsClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_GuardrailsUsageLogsGuardrailsUsageLogsGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_GuardrailsUsageLogsGuardrailsUsageLogsGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_GuardrailsUsageLogsGuardrailsUsageLogsGetSecurityRequirement0,
            };
        partial void PrepareGuardrailsUsageLogsGuardrailsUsageLogsGetArguments(
            ...
            ref string? endDate);
        partial void PrepareGuardrailsUsageLogsGuardrailsUsageLogsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? startDate,
            string? endDate);
        partial void ProcessGuardrailsUsageLogsGuardrailsUsageLogsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGuardrailsUsageLogsGuardrailsUsageLogsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.UsageLogsResponse> GuardrailsUsageLogsGuardrailsUsageLogsGetAsync(
        ...
        {
            var __response = await GuardrailsUsageLogsGuardrailsUsageLogsGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.UsageLogsResponse>> GuardrailsUsageLogsGuardrailsUsageLogsGetAsResponseAsync(
            string? guardrailId = default,
            string? policyId = default,
            int? page = default,
            int? pageSize = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGuardrailsUsageLogsGuardrailsUsageLogsGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GuardrailsUsageLogsGuardrailsUsageLogsGetSecurityRequirements,
                operationName: "GuardrailsUsageLogsGuardrailsUsageLogsGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("guardrail_id", guardrailId)
                                .AddOptionalParameter("policy_id", policyId)
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGuardrailsUsageLogsGuardrailsUsageLogsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GuardrailsUsageLogsGuardrailsUsageLogsGet",
                                methodName: "GuardrailsUsageLogsGuardrailsUsageLogsGetAsync",
                                pathTemplate: "\"/guardrails/usage/logs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGuardrailsUsageLogsGuardrailsUsageLogsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGuardrailsUsageLogsGuardrailsUsageLogsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.UsageLogsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.UsageLogsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.UsageLogsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
