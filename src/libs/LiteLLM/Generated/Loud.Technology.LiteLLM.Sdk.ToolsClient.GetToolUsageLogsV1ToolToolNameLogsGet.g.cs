...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class ToolsClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_GetToolUsageLogsV1ToolToolNameLogsGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_GetToolUsageLogsV1ToolToolNameLogsGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_GetToolUsageLogsV1ToolToolNameLogsGetSecurityRequirement0,
            };
        partial void PrepareGetToolUsageLogsV1ToolToolNameLogsGetArguments(
            ...
            ref string? endDate);
        partial void PrepareGetToolUsageLogsV1ToolToolNameLogsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? startDate,
            string? endDate);
        partial void ProcessGetToolUsageLogsV1ToolToolNameLogsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetToolUsageLogsV1ToolToolNameLogsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.ToolUsageLogsResponse> GetToolUsageLogsV1ToolToolNameLogsGetAsync(
            string toolName,
            int? page = default,
        ...
        {
            var __response = await GetToolUsageLogsV1ToolToolNameLogsGetAsResponseAsync(
                toolName: toolName,
                page: page,
                pageSize: pageSize,
                startDate: startDate,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.ToolUsageLogsResponse>> GetToolUsageLogsV1ToolToolNameLogsGetAsResponseAsync(
            string toolName,
            int? page = default,
            int? pageSize = default,
            string? startDate = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetToolUsageLogsV1ToolToolNameLogsGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetToolUsageLogsV1ToolToolNameLogsGetSecurityRequirements,
                operationName: "GetToolUsageLogsV1ToolToolNameLogsGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetToolUsageLogsV1ToolToolNameLogsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetToolUsageLogsV1ToolToolNameLogsGet",
                                methodName: "GetToolUsageLogsV1ToolToolNameLogsGetAsync",
                                pathTemplate: "$\"/v1/tool/{toolName}/logs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetToolUsageLogsV1ToolToolNameLogsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetToolUsageLogsV1ToolToolNameLogsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.ToolUsageLogsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.ToolUsageLogsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.ToolUsageLogsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
