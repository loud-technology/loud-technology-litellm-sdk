...
{
    /// <summary>
    /// Pydantic model for chat completion requests that includes both OpenAI standard fields<br/>
    ...
    public sealed partial class ProxyChatCompletionRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyChatCompletionRequest" /> class.
        /// </summary>
...
#endif
        public ProxyChatCompletionRequest(
            string model,
