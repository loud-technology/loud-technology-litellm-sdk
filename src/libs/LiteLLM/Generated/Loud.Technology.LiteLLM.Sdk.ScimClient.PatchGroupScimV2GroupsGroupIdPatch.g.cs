...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class ScimClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_PatchGroupScimV2GroupsGroupIdPatchSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_PatchGroupScimV2GroupsGroupIdPatchSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_PatchGroupScimV2GroupsGroupIdPatchSecurityRequirement0,
            };
        partial void PreparePatchGroupScimV2GroupsGroupIdPatchArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string groupId,
            ref string? feature,
            global::Loud.Technology.LiteLLM.Sdk.SCIMPatchOp request);
        partial void PreparePatchGroupScimV2GroupsGroupIdPatchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string groupId,
            string? feature,
            global::Loud.Technology.LiteLLM.Sdk.SCIMPatchOp request);
        partial void ProcessPatchGroupScimV2GroupsGroupIdPatchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPatchGroupScimV2GroupsGroupIdPatchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.SCIMGroup> PatchGroupScimV2GroupsGroupIdPatchAsync(
            string groupId,
        ...
        {
            var __response = await PatchGroupScimV2GroupsGroupIdPatchAsResponseAsync(
                groupId: groupId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.SCIMGroup>> PatchGroupScimV2GroupsGroupIdPatchAsResponseAsync(
            string groupId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePatchGroupScimV2GroupsGroupIdPatchArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PatchGroupScimV2GroupsGroupIdPatchSecurityRequirements,
                operationName: "PatchGroupScimV2GroupsGroupIdPatchAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePatchGroupScimV2GroupsGroupIdPatchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PatchGroupScimV2GroupsGroupIdPatch",
                                methodName: "PatchGroupScimV2GroupsGroupIdPatchAsync",
                                pathTemplate: "$\"/scim/v2/Groups/{groupId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPatchGroupScimV2GroupsGroupIdPatchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPatchGroupScimV2GroupsGroupIdPatchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.SCIMGroup.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.SCIMGroup>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.SCIMGroup.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.SCIMGroup> PatchGroupScimV2GroupsGroupIdPatchAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.SCIMPatchOp
            {
                Operations = operations,
                Schemas = schemas,
            };

            return await PatchGroupScimV2GroupsGroupIdPatchAsync(
                groupId: groupId,
                feature: feature,
                request: __request,
                requestOptions: requestOptions,
