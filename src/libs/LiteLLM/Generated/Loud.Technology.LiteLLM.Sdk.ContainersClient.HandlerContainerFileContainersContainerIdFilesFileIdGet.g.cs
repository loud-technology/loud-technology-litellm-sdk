...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class ContainersClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_HandlerContainerFileContainersContainerIdFilesFileIdGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_HandlerContainerFileContainersContainerIdFilesFileIdGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_HandlerContainerFileContainersContainerIdFilesFileIdGetSecurityRequirement0,
            };
        partial void PrepareHandlerContainerFileContainersContainerIdFilesFileIdGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string containerId,
            ref string fileId);
        partial void PrepareHandlerContainerFileContainersContainerIdFilesFileIdGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string containerId,
            string fileId);
        partial void ProcessHandlerContainerFileContainersContainerIdFilesFileIdGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessHandlerContainerFileContainersContainerIdFilesFileIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> HandlerContainerFileContainersContainerIdFilesFileIdGetAsync(
            string containerId,
            string fileId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await HandlerContainerFileContainersContainerIdFilesFileIdGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> HandlerContainerFileContainersContainerIdFilesFileIdGetAsResponseAsync(
            string containerId,
            string fileId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareHandlerContainerFileContainersContainerIdFilesFileIdGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_HandlerContainerFileContainersContainerIdFilesFileIdGetSecurityRequirements,
                operationName: "HandlerContainerFileContainersContainerIdFilesFileIdGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareHandlerContainerFileContainersContainerIdFilesFileIdGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "HandlerContainerFileContainersContainerIdFilesFileIdGet",
                                methodName: "HandlerContainerFileContainersContainerIdFilesFileIdGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessHandlerContainerFileContainersContainerIdFilesFileIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessHandlerContainerFileContainersContainerIdFilesFileIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
