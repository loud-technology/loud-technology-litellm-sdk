...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class HealthClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_SharedHealthCheckStatusEndpointHealthSharedStatusGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_SharedHealthCheckStatusEndpointHealthSharedStatusGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_SharedHealthCheckStatusEndpointHealthSharedStatusGetSecurityRequirement0,
            };
        partial void PrepareSharedHealthCheckStatusEndpointHealthSharedStatusGetArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareSharedHealthCheckStatusEndpointHealthSharedStatusGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessSharedHealthCheckStatusEndpointHealthSharedStatusGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSharedHealthCheckStatusEndpointHealthSharedStatusGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Shared Health Check Status Endpoint<br/>
        /// Get the status of shared health check coordination across pods.<br/>
        ...
        public async global::System.Threading.Tasks.Task<string> SharedHealthCheckStatusEndpointHealthSharedStatusGetAsync(
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SharedHealthCheckStatusEndpointHealthSharedStatusGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> SharedHealthCheckStatusEndpointHealthSharedStatusGetAsResponseAsync(
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSharedHealthCheckStatusEndpointHealthSharedStatusGetArguments(
                httpClient: HttpClient);


            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_SharedHealthCheckStatusEndpointHealthSharedStatusGetSecurityRequirements,
                operationName: "SharedHealthCheckStatusEndpointHealthSharedStatusGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSharedHealthCheckStatusEndpointHealthSharedStatusGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SharedHealthCheckStatusEndpointHealthSharedStatusGet",
                                methodName: "SharedHealthCheckStatusEndpointHealthSharedStatusGetAsync",
                                pathTemplate: "\"/health/shared-status\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSharedHealthCheckStatusEndpointHealthSharedStatusGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSharedHealthCheckStatusEndpointHealthSharedStatusGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
