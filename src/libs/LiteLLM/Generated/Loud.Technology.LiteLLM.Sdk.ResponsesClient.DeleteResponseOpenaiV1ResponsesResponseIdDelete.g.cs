...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class ResponsesClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_DeleteResponseOpenaiV1ResponsesResponseIdDeleteSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_DeleteResponseOpenaiV1ResponsesResponseIdDeleteSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_DeleteResponseOpenaiV1ResponsesResponseIdDeleteSecurityRequirement0,
            };
        partial void PrepareDeleteResponseOpenaiV1ResponsesResponseIdDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string responseId);
        partial void PrepareDeleteResponseOpenaiV1ResponsesResponseIdDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string responseId);
        partial void ProcessDeleteResponseOpenaiV1ResponsesResponseIdDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteResponseOpenaiV1ResponsesResponseIdDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> DeleteResponseOpenaiV1ResponsesResponseIdDeleteAsync(
            string responseId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DeleteResponseOpenaiV1ResponsesResponseIdDeleteAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> DeleteResponseOpenaiV1ResponsesResponseIdDeleteAsResponseAsync(
            string responseId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteResponseOpenaiV1ResponsesResponseIdDeleteArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteResponseOpenaiV1ResponsesResponseIdDeleteSecurityRequirements,
                operationName: "DeleteResponseOpenaiV1ResponsesResponseIdDeleteAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: $"/openai/v1/responses/{responseId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteResponseOpenaiV1ResponsesResponseIdDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteResponseOpenaiV1ResponsesResponseIdDelete",
                                methodName: "DeleteResponseOpenaiV1ResponsesResponseIdDeleteAsync",
                                pathTemplate: "$\"/openai/v1/responses/{responseId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteResponseOpenaiV1ResponsesResponseIdDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteResponseOpenaiV1ResponsesResponseIdDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
