...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_CreateFileProviderV1FilesPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_CreateFileProviderV1FilesPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_CreateFileProviderV1FilesPostSecurityRequirement0,
            };
        partial void PrepareCreateFileProviderV1FilesPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? provider,
            global::Loud.Technology.LiteLLM.Sdk.BodyCreateFileProviderV1FilesPost request);
        partial void PrepareCreateFileProviderV1FilesPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? provider,
            global::Loud.Technology.LiteLLM.Sdk.BodyCreateFileProviderV1FilesPost request);
        partial void ProcessCreateFileProviderV1FilesPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateFileProviderV1FilesPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> CreateFileProviderV1FilesPostAsync(
            string? provider,
        ...
        {
            var __response = await CreateFileProviderV1FilesPostAsResponseAsync(
                provider: provider,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> CreateFileProviderV1FilesPostAsResponseAsync(
            string? provider,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateFileProviderV1FilesPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateFileProviderV1FilesPostSecurityRequirements,
                operationName: "CreateFileProviderV1FilesPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            __httpRequestContent.Add(
                                content: new global::System.Net.Http.StringContent(provider ?? string.Empty),
                                name: "\"provider\"");
                            ...
                            if (request.TargetModelNames != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.TargetModelNames ?? string.Empty),
                                    name: "\"target_model_names\"");

                            }
                            if (request.TargetStorage != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.TargetStorage ?? string.Empty),
                                    name: "\"target_storage\"");

                            }
                            if (request.CustomLlmProvider != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.CustomLlmProvider ?? string.Empty),
                            ...
                            if (request.LitellmMetadata != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.LitellmMetadata ?? string.Empty),
                                    name: "\"litellm_metadata\"");
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateFileProviderV1FilesPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateFileProviderV1FilesPost",
                                methodName: "CreateFileProviderV1FilesPostAsync",
                                pathTemplate: "$\"/{provider}/v1/files\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateFileProviderV1FilesPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateFileProviderV1FilesPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> CreateFileProviderV1FilesPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.BodyCreateFileProviderV1FilesPost
            {
                Purpose = purpose,
                ...
                File = file,
                Filename = filename,
                LitellmMetadata = litellmMetadata,
            };

            return await CreateFileProviderV1FilesPostAsync(
                provider: provider,
                request: __request,
                requestOptions: requestOptions,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Loud.Technology.LiteLLM.Sdk.BodyCreateFileProviderV1FilesPost
            {
                Purpose = purpose,
                TargetModelNames = targetModelNames,
                TargetStorage = targetStorage,
