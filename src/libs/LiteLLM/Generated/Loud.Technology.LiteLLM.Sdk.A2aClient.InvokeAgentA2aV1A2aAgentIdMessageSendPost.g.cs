...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class A2aClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_InvokeAgentA2aV1A2aAgentIdMessageSendPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_InvokeAgentA2aV1A2aAgentIdMessageSendPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_InvokeAgentA2aV1A2aAgentIdMessageSendPostSecurityRequirement0,
            };
        partial void PrepareInvokeAgentA2aV1A2aAgentIdMessageSendPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string agentId);
        partial void PrepareInvokeAgentA2aV1A2aAgentIdMessageSendPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string agentId);
        partial void ProcessInvokeAgentA2aV1A2aAgentIdMessageSendPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInvokeAgentA2aV1A2aAgentIdMessageSendPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> InvokeAgentA2aV1A2aAgentIdMessageSendPostAsync(
            string agentId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await InvokeAgentA2aV1A2aAgentIdMessageSendPostAsResponseAsync(
                agentId: agentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> InvokeAgentA2aV1A2aAgentIdMessageSendPostAsResponseAsync(
            string agentId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareInvokeAgentA2aV1A2aAgentIdMessageSendPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_InvokeAgentA2aV1A2aAgentIdMessageSendPostSecurityRequirements,
                operationName: "InvokeAgentA2aV1A2aAgentIdMessageSendPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: $"/v1/a2a/{agentId}/message/send",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInvokeAgentA2aV1A2aAgentIdMessageSendPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "InvokeAgentA2aV1A2aAgentIdMessageSendPost",
                                methodName: "InvokeAgentA2aV1A2aAgentIdMessageSendPostAsync",
                                pathTemplate: "$\"/v1/a2a/{agentId}/message/send\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInvokeAgentA2aV1A2aAgentIdMessageSendPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessInvokeAgentA2aV1A2aAgentIdMessageSendPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
