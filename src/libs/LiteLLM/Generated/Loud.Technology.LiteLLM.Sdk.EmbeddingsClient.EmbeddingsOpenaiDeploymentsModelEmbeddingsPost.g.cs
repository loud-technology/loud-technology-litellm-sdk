...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class EmbeddingsClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_EmbeddingsOpenaiDeploymentsModelEmbeddingsPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_EmbeddingsOpenaiDeploymentsModelEmbeddingsPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_EmbeddingsOpenaiDeploymentsModelEmbeddingsPostSecurityRequirement0,
            };
        partial void PrepareEmbeddingsOpenaiDeploymentsModelEmbeddingsPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? model,
            global::Loud.Technology.LiteLLM.Sdk.EmbeddingsOpenaiDeploymentsModelEmbeddingsPostRequest request);
        partial void PrepareEmbeddingsOpenaiDeploymentsModelEmbeddingsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? model,
            global::Loud.Technology.LiteLLM.Sdk.EmbeddingsOpenaiDeploymentsModelEmbeddingsPostRequest request);
        partial void ProcessEmbeddingsOpenaiDeploymentsModelEmbeddingsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEmbeddingsOpenaiDeploymentsModelEmbeddingsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> EmbeddingsOpenaiDeploymentsModelEmbeddingsPostAsync(
            string? model,
        ...
        {
            var __response = await EmbeddingsOpenaiDeploymentsModelEmbeddingsPostAsResponseAsync(
                model: model,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> EmbeddingsOpenaiDeploymentsModelEmbeddingsPostAsResponseAsync(
            string? model,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEmbeddingsOpenaiDeploymentsModelEmbeddingsPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EmbeddingsOpenaiDeploymentsModelEmbeddingsPostSecurityRequirements,
                operationName: "EmbeddingsOpenaiDeploymentsModelEmbeddingsPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEmbeddingsOpenaiDeploymentsModelEmbeddingsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EmbeddingsOpenaiDeploymentsModelEmbeddingsPost",
                                methodName: "EmbeddingsOpenaiDeploymentsModelEmbeddingsPostAsync",
                                pathTemplate: "$\"/openai/deployments/{model}/embeddings\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEmbeddingsOpenaiDeploymentsModelEmbeddingsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEmbeddingsOpenaiDeploymentsModelEmbeddingsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> EmbeddingsOpenaiDeploymentsModelEmbeddingsPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.EmbeddingsOpenaiDeploymentsModelEmbeddingsPostRequest
            {
                Model = requestModel,
                Input = input,
                Timeout = timeout,
                ...
                LitellmCallId = litellmCallId,
                LitellmLoggingObj = litellmLoggingObj,
                LoggerFn = loggerFn,
            };

            return await EmbeddingsOpenaiDeploymentsModelEmbeddingsPostAsync(
                model: model,
                request: __request,
                requestOptions: requestOptions,
