...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class GuardrailsClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_RejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_RejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_RejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostSecurityRequirement0,
            };
        partial void PrepareRejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string guardrailId);
        partial void PrepareRejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string guardrailId);
        partial void ProcessRejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> RejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostAsync(
            string guardrailId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await RejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> RejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostAsResponseAsync(
            string guardrailId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostSecurityRequirements,
                operationName: "RejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: $"/guardrails/submissions/{guardrailId}/reject",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPost",
                                methodName: "RejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostAsync",
                                pathTemplate: "$\"/guardrails/submissions/{guardrailId}/reject\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRejectGuardrailSubmissionGuardrailsSubmissionsGuardrailIdRejectPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
