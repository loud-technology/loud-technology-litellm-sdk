...
{
    public partial class MemoryManagementClient
    {


        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_UpsertMemoryV1MemoryKeyPutSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_UpsertMemoryV1MemoryKeyPutSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_UpsertMemoryV1MemoryKeyPutSecurityRequirement0,
            };
        partial void PrepareUpsertMemoryV1MemoryKeyPutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string key,
            global::Loud.Technology.LiteLLM.Sdk.MemoryUpdateRequest request);
        partial void PrepareUpsertMemoryV1MemoryKeyPutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string key,
            global::Loud.Technology.LiteLLM.Sdk.MemoryUpdateRequest request);
        partial void ProcessUpsertMemoryV1MemoryKeyPutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpsertMemoryV1MemoryKeyPutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.LiteLLMMemoryRow> UpsertMemoryV1MemoryKeyPutAsync(
            string key,
        ...
        {
            var __response = await UpsertMemoryV1MemoryKeyPutAsResponseAsync(
                key: key,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.LiteLLMMemoryRow>> UpsertMemoryV1MemoryKeyPutAsResponseAsync(
            string key,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpsertMemoryV1MemoryKeyPutArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpsertMemoryV1MemoryKeyPutSecurityRequirements,
                operationName: "UpsertMemoryV1MemoryKeyPutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpsertMemoryV1MemoryKeyPutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpsertMemoryV1MemoryKeyPut",
                                methodName: "UpsertMemoryV1MemoryKeyPutAsync",
                                pathTemplate: "$\"/v1/memory/{key}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpsertMemoryV1MemoryKeyPutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpsertMemoryV1MemoryKeyPutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.LiteLLMMemoryRow.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.LiteLLMMemoryRow>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.LiteLLMMemoryRow.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.LiteLLMMemoryRow> UpsertMemoryV1MemoryKeyPutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.MemoryUpdateRequest
            {
                Value = value,
                Metadata = metadata,
                UserId = userId,
            ...
            return await UpsertMemoryV1MemoryKeyPutAsync(
                key: key,
                request: __request,
                requestOptions: requestOptions,
