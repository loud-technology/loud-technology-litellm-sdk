...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class BatchClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_ListBatchesProviderV1BatchesGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_ListBatchesProviderV1BatchesGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_ListBatchesProviderV1BatchesGetSecurityRequirement0,
            };
        partial void PrepareListBatchesProviderV1BatchesGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? provider,
            int? limit,
            ref string? after,
            ref string? targetModelNames);
        partial void PrepareListBatchesProviderV1BatchesGetRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessListBatchesProviderV1BatchesGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListBatchesProviderV1BatchesGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ListBatchesProviderV1BatchesGetAsync(
            string? provider,
            int? limit = default,
        ...
        {
            var __response = await ListBatchesProviderV1BatchesGetAsResponseAsync(
                provider: provider,
                limit: limit,
                after: after,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> ListBatchesProviderV1BatchesGetAsResponseAsync(
            string? provider,
            int? limit = default,
            string? after = default,
            string? targetModelNames = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListBatchesProviderV1BatchesGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListBatchesProviderV1BatchesGetSecurityRequirements,
                operationName: "ListBatchesProviderV1BatchesGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListBatchesProviderV1BatchesGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListBatchesProviderV1BatchesGet",
                                methodName: "ListBatchesProviderV1BatchesGetAsync",
                                pathTemplate: "$\"/{provider}/v1/batches\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListBatchesProviderV1BatchesGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListBatchesProviderV1BatchesGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
