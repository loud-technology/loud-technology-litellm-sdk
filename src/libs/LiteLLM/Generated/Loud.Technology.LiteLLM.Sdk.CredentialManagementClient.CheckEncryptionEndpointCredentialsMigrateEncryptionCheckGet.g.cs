...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class CredentialManagementClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_CheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_CheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_CheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetSecurityRequirement0,
            };
        partial void PrepareCheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareCheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessCheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> CheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetAsync(
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> CheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetAsResponseAsync(
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetArguments(
                httpClient: HttpClient);


            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_CheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetSecurityRequirements,
                operationName: "CheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: "/credentials/migrate-encryption/check",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CheckEncryptionEndpointCredentialsMigrateEncryptionCheckGet",
                                methodName: "CheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetAsync",
                                pathTemplate: "\"/credentials/migrate-encryption/check\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCheckEncryptionEndpointCredentialsMigrateEncryptionCheckGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
