...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class KeyManagementClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_KeyAliasesKeyAliasesGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_KeyAliasesKeyAliasesGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_KeyAliasesKeyAliasesGetSecurityRequirement0,
            };
        partial void PrepareKeyAliasesKeyAliasesGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? page,
            ref int? size,
            ref string? search,
            ref string? teamId);
        partial void PrepareKeyAliasesKeyAliasesGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? search,
            string? teamId);
        partial void ProcessKeyAliasesKeyAliasesGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessKeyAliasesKeyAliasesGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> KeyAliasesKeyAliasesGetAsync(
            int? page = default,
            int? size = default,
        ...
        {
            var __response = await KeyAliasesKeyAliasesGetAsResponseAsync(
                page: page,
                size: size,
                search: search,
                teamId: teamId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> KeyAliasesKeyAliasesGetAsResponseAsync(
            int? page = default,
            int? size = default,
            string? search = default,
            string? teamId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareKeyAliasesKeyAliasesGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_KeyAliasesKeyAliasesGetSecurityRequirements,
                operationName: "KeyAliasesKeyAliasesGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareKeyAliasesKeyAliasesGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "KeyAliasesKeyAliasesGet",
                                methodName: "KeyAliasesKeyAliasesGetAsync",
                                pathTemplate: "\"/key/aliases\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessKeyAliasesKeyAliasesGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessKeyAliasesKeyAliasesGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
