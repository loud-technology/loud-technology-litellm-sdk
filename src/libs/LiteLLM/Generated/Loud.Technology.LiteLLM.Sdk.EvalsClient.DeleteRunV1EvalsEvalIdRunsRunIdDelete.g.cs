...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class EvalsClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_DeleteRunV1EvalsEvalIdRunsRunIdDeleteSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_DeleteRunV1EvalsEvalIdRunsRunIdDeleteSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_DeleteRunV1EvalsEvalIdRunsRunIdDeleteSecurityRequirement0,
            };
        partial void PrepareDeleteRunV1EvalsEvalIdRunsRunIdDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string evalId,
            ref string runId,
            ref string? customLlmProvider);
        partial void PrepareDeleteRunV1EvalsEvalIdRunsRunIdDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string evalId,
            string runId,
            string? customLlmProvider);
        partial void ProcessDeleteRunV1EvalsEvalIdRunsRunIdDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteRunV1EvalsEvalIdRunsRunIdDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// Example usage:<br/>
        /// ```bash<br/>
        /// curl -X DELETE "http://localhost:4000/v1/evals/eval_123/runs/run_456"       -H "Authorization: Bearer your-key"<br/>
        /// ```<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.RunDeleteResponse> DeleteRunV1EvalsEvalIdRunsRunIdDeleteAsync(
            string evalId,
            string runId,
        ...
        {
            var __response = await DeleteRunV1EvalsEvalIdRunsRunIdDeleteAsResponseAsync(
                evalId: evalId,
                runId: runId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.RunDeleteResponse>> DeleteRunV1EvalsEvalIdRunsRunIdDeleteAsResponseAsync(
            string evalId,
            string runId,
            string? customLlmProvider = default,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteRunV1EvalsEvalIdRunsRunIdDeleteArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteRunV1EvalsEvalIdRunsRunIdDeleteSecurityRequirements,
                operationName: "DeleteRunV1EvalsEvalIdRunsRunIdDeleteAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: $"/v1/evals/{evalId}/runs/{runId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteRunV1EvalsEvalIdRunsRunIdDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteRunV1EvalsEvalIdRunsRunIdDelete",
                                methodName: "DeleteRunV1EvalsEvalIdRunsRunIdDeleteAsync",
                                pathTemplate: "$\"/v1/evals/{evalId}/runs/{runId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteRunV1EvalsEvalIdRunsRunIdDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteRunV1EvalsEvalIdRunsRunIdDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.RunDeleteResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.RunDeleteResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.RunDeleteResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
