...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class GuardrailsClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_GuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_GuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_GuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetSecurityRequirement0,
            };
        partial void PrepareGuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string guardrailId,
            ref string? startDate,
            ref string? endDate);
        partial void PrepareGuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string guardrailId,
            string? startDate,
            string? endDate);
        partial void ProcessGuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.UsageDetailResponse> GuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetAsync(
            string guardrailId,
        ...
        {
            var __response = await GuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.UsageDetailResponse>> GuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetAsResponseAsync(
            string guardrailId,
            string? startDate = default,
            string? endDate = default,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetSecurityRequirements,
                operationName: "GuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: $"/guardrails/usage/detail/{guardrailId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGet",
                                methodName: "GuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetAsync",
                                pathTemplate: "$\"/guardrails/usage/detail/{guardrailId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGuardrailsUsageDetailGuardrailsUsageDetailGuardrailIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.UsageDetailResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.UsageDetailResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.UsageDetailResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
