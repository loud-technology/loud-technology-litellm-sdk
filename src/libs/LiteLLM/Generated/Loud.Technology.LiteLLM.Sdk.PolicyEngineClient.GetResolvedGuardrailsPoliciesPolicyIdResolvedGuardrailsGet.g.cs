...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class PolicyEngineClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_GetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_GetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_GetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetSecurityRequirement0,
            };
        partial void PrepareGetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string policyId);
        partial void PrepareGetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string policyId);
        partial void ProcessGetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> GetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetAsync(
            string policyId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetAsResponseAsync(
                policyId: policyId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> GetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetAsResponseAsync(
            string policyId,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetSecurityRequirements,
                operationName: "GetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: $"/policies/{policyId}/resolved-guardrails",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGet",
                                methodName: "GetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetAsync",
                                pathTemplate: "$\"/policies/{policyId}/resolved-guardrails\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetResolvedGuardrailsPoliciesPolicyIdResolvedGuardrailsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
