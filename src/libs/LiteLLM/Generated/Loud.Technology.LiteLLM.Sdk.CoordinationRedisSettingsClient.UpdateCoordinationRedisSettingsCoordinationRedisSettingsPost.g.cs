...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class CoordinationRedisSettingsClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_UpdateCoordinationRedisSettingsCoordinationRedisSettingsPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_UpdateCoordinationRedisSettingsCoordinationRedisSettingsPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_UpdateCoordinationRedisSettingsCoordinationRedisSettingsPostSecurityRequirement0,
            };
        partial void PrepareUpdateCoordinationRedisSettingsCoordinationRedisSettingsPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? litellmChangedBy,
            global::Loud.Technology.LiteLLM.Sdk.CoordinationRedisSettingsRequest request);
        partial void PrepareUpdateCoordinationRedisSettingsCoordinationRedisSettingsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? litellmChangedBy,
            global::Loud.Technology.LiteLLM.Sdk.CoordinationRedisSettingsRequest request);
        partial void ProcessUpdateCoordinationRedisSettingsCoordinationRedisSettingsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateCoordinationRedisSettingsCoordinationRedisSettingsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateCoordinationRedisSettingsCoordinationRedisSettingsPostAsync(
        ...
        {
            var __response = await UpdateCoordinationRedisSettingsCoordinationRedisSettingsPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> UpdateCoordinationRedisSettingsCoordinationRedisSettingsPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateCoordinationRedisSettingsCoordinationRedisSettingsPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateCoordinationRedisSettingsCoordinationRedisSettingsPostSecurityRequirements,
                operationName: "UpdateCoordinationRedisSettingsCoordinationRedisSettingsPostAsync");
            ...
            if (litellmChangedBy != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateCoordinationRedisSettingsCoordinationRedisSettingsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateCoordinationRedisSettingsCoordinationRedisSettingsPost",
                                methodName: "UpdateCoordinationRedisSettingsCoordinationRedisSettingsPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateCoordinationRedisSettingsCoordinationRedisSettingsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateCoordinationRedisSettingsCoordinationRedisSettingsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await UpdateCoordinationRedisSettingsCoordinationRedisSettingsPostAsync(
                litellmChangedBy: litellmChangedBy,
                request: __request,
                requestOptions: requestOptions,
