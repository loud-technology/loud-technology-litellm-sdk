...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class CredentialManagementClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_UpdateCredentialCredentialsCredentialNamePatchSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_UpdateCredentialCredentialsCredentialNamePatchSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_UpdateCredentialCredentialsCredentialNamePatchSecurityRequirement0,
            };
        partial void PrepareUpdateCredentialCredentialsCredentialNamePatchArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string credentialName,
            global::Loud.Technology.LiteLLM.Sdk.CredentialItem request);
        partial void PrepareUpdateCredentialCredentialsCredentialNamePatchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string credentialName,
            global::Loud.Technology.LiteLLM.Sdk.CredentialItem request);
        partial void ProcessUpdateCredentialCredentialsCredentialNamePatchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateCredentialCredentialsCredentialNamePatchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateCredentialCredentialsCredentialNamePatchAsync(
            string credentialName,
        ...
        {
            var __response = await UpdateCredentialCredentialsCredentialNamePatchAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> UpdateCredentialCredentialsCredentialNamePatchAsResponseAsync(
            string credentialName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateCredentialCredentialsCredentialNamePatchArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateCredentialCredentialsCredentialNamePatchSecurityRequirements,
                operationName: "UpdateCredentialCredentialsCredentialNamePatchAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateCredentialCredentialsCredentialNamePatchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateCredentialCredentialsCredentialNamePatch",
                                methodName: "UpdateCredentialCredentialsCredentialNamePatchAsync",
                                pathTemplate: "$\"/credentials/{credentialName}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateCredentialCredentialsCredentialNamePatchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateCredentialCredentialsCredentialNamePatchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateCredentialCredentialsCredentialNamePatchAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.CredentialItem
            {
                CredentialName = requestCredentialName,
                CredentialInfo = credentialInfo,
                CredentialValues = credentialValues,
            };

            return await UpdateCredentialCredentialsCredentialNamePatchAsync(
                credentialName: credentialName,
                request: __request,
                requestOptions: requestOptions,
