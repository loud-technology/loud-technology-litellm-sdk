...
{
    /// <summary>
    /// UpdateTeamRequest, used by /team/update when you need to update a team<br/>
    /// team_id: str<br/>
    /// team_alias: Optional[str] = None<br/>
    /// organization_id: Optional[str] = None<br/>
    /// metadata: Optional[dict] = None<br/>
    /// tpm_limit: Optional[int] = None<br/>
    /// rpm_limit: Optional[int] = None<br/>
    /// max_budget: Optional[float] = None<br/>
    /// models: Optional[list] = None<br/>
    /// blocked: Optional[bool] = None<br/>
    /// budget_duration: Optional[str] = None<br/>
    /// guardrails: Optional[List[str]] = None<br/>
