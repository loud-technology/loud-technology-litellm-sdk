...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class WorkflowManagementClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_AppendWorkflowEventV1WorkflowsRunsRunIdEventsPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_AppendWorkflowEventV1WorkflowsRunsRunIdEventsPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_AppendWorkflowEventV1WorkflowsRunsRunIdEventsPostSecurityRequirement0,
            };
        partial void PrepareAppendWorkflowEventV1WorkflowsRunsRunIdEventsPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string runId,
            global::Loud.Technology.LiteLLM.Sdk.WorkflowEventCreateRequest request);
        partial void PrepareAppendWorkflowEventV1WorkflowsRunsRunIdEventsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string runId,
            global::Loud.Technology.LiteLLM.Sdk.WorkflowEventCreateRequest request);
        partial void ProcessAppendWorkflowEventV1WorkflowsRunsRunIdEventsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAppendWorkflowEventV1WorkflowsRunsRunIdEventsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> AppendWorkflowEventV1WorkflowsRunsRunIdEventsPostAsync(
            string runId,
        ...
        {
            var __response = await AppendWorkflowEventV1WorkflowsRunsRunIdEventsPostAsResponseAsync(
                runId: runId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> AppendWorkflowEventV1WorkflowsRunsRunIdEventsPostAsResponseAsync(
            string runId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAppendWorkflowEventV1WorkflowsRunsRunIdEventsPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AppendWorkflowEventV1WorkflowsRunsRunIdEventsPostSecurityRequirements,
                operationName: "AppendWorkflowEventV1WorkflowsRunsRunIdEventsPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: $"/v1/workflows/runs/{runId}/events",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAppendWorkflowEventV1WorkflowsRunsRunIdEventsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AppendWorkflowEventV1WorkflowsRunsRunIdEventsPost",
                                methodName: "AppendWorkflowEventV1WorkflowsRunsRunIdEventsPostAsync",
                                pathTemplate: "$\"/v1/workflows/runs/{runId}/events\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAppendWorkflowEventV1WorkflowsRunsRunIdEventsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAppendWorkflowEventV1WorkflowsRunsRunIdEventsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> AppendWorkflowEventV1WorkflowsRunsRunIdEventsPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.WorkflowEventCreateRequest
            {
                EventType = eventType,
                StepName = stepName,
                Data = data,
            ...
            return await AppendWorkflowEventV1WorkflowsRunsRunIdEventsPostAsync(
                runId: runId,
                request: __request,
                requestOptions: requestOptions,
