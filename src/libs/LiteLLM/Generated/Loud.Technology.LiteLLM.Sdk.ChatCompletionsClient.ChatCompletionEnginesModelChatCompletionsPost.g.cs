...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class ChatCompletionsClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_ChatCompletionEnginesModelChatCompletionsPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_ChatCompletionEnginesModelChatCompletionsPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_ChatCompletionEnginesModelChatCompletionsPostSecurityRequirement0,
            };
        partial void PrepareChatCompletionEnginesModelChatCompletionsPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? model,
            global::Loud.Technology.LiteLLM.Sdk.ChatCompletionEnginesModelChatCompletionsPostRequest request);
        partial void PrepareChatCompletionEnginesModelChatCompletionsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? model,
            global::Loud.Technology.LiteLLM.Sdk.ChatCompletionEnginesModelChatCompletionsPostRequest request);
        partial void ProcessChatCompletionEnginesModelChatCompletionsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChatCompletionEnginesModelChatCompletionsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ChatCompletionEnginesModelChatCompletionsPostAsync(
            string? model,
        ...
        {
            var __response = await ChatCompletionEnginesModelChatCompletionsPostAsResponseAsync(
                model: model,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> ChatCompletionEnginesModelChatCompletionsPostAsResponseAsync(
            string? model,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareChatCompletionEnginesModelChatCompletionsPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChatCompletionEnginesModelChatCompletionsPostSecurityRequirements,
                operationName: "ChatCompletionEnginesModelChatCompletionsPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareChatCompletionEnginesModelChatCompletionsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ChatCompletionEnginesModelChatCompletionsPost",
                                methodName: "ChatCompletionEnginesModelChatCompletionsPostAsync",
                                pathTemplate: "$\"/engines/{model}/chat/completions\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessChatCompletionEnginesModelChatCompletionsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessChatCompletionEnginesModelChatCompletionsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> ChatCompletionEnginesModelChatCompletionsPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.ChatCompletionEnginesModelChatCompletionsPostRequest
            {
                Model = requestModel,
                Messages = messages,
            ...
            return await ChatCompletionEnginesModelChatCompletionsPostAsync(
                model: model,
                request: __request,
                requestOptions: requestOptions,
