...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class WebSocketClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_WebsocketResponsesWebsocketEndpointGet2SecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_WebsocketResponsesWebsocketEndpointGet2SecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_WebsocketResponsesWebsocketEndpointGet2SecurityRequirement0,
            };
        partial void PrepareWebsocketResponsesWebsocketEndpointGet2Arguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareWebsocketResponsesWebsocketEndpointGet2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessWebsocketResponsesWebsocketEndpointGet2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// WebSocket: responses_websocket_endpoint<br/>
        /// WebSocket connection endpoint
        /// </summary>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task WebsocketResponsesWebsocketEndpointGet2Async(
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await WebsocketResponsesWebsocketEndpointGet2AsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse> WebsocketResponsesWebsocketEndpointGet2AsResponseAsync(
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebsocketResponsesWebsocketEndpointGet2Arguments(
                httpClient: HttpClient);


            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_WebsocketResponsesWebsocketEndpointGet2SecurityRequirements,
                operationName: "WebsocketResponsesWebsocketEndpointGet2Async");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebsocketResponsesWebsocketEndpointGet2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebsocketResponsesWebsocketEndpointGet2",
                                methodName: "WebsocketResponsesWebsocketEndpointGet2Async",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebsocketResponsesWebsocketEndpointGet2Response(
                    httpClient: HttpClient,
