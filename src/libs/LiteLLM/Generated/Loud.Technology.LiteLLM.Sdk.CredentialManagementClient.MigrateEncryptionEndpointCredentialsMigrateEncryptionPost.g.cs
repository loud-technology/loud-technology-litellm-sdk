...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class CredentialManagementClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_MigrateEncryptionEndpointCredentialsMigrateEncryptionPostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_MigrateEncryptionEndpointCredentialsMigrateEncryptionPostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_MigrateEncryptionEndpointCredentialsMigrateEncryptionPostSecurityRequirement0,
            };
        partial void PrepareMigrateEncryptionEndpointCredentialsMigrateEncryptionPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? dryRun);
        partial void PrepareMigrateEncryptionEndpointCredentialsMigrateEncryptionPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? dryRun);
        partial void ProcessMigrateEncryptionEndpointCredentialsMigrateEncryptionPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMigrateEncryptionEndpointCredentialsMigrateEncryptionPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> MigrateEncryptionEndpointCredentialsMigrateEncryptionPostAsync(
            bool? dryRun = default,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await MigrateEncryptionEndpointCredentialsMigrateEncryptionPostAsResponseAsync(
                dryRun: dryRun,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> MigrateEncryptionEndpointCredentialsMigrateEncryptionPostAsResponseAsync(
            bool? dryRun = default,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareMigrateEncryptionEndpointCredentialsMigrateEncryptionPostArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_MigrateEncryptionEndpointCredentialsMigrateEncryptionPostSecurityRequirements,
                operationName: "MigrateEncryptionEndpointCredentialsMigrateEncryptionPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareMigrateEncryptionEndpointCredentialsMigrateEncryptionPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "MigrateEncryptionEndpointCredentialsMigrateEncryptionPost",
                                methodName: "MigrateEncryptionEndpointCredentialsMigrateEncryptionPostAsync",
                                pathTemplate: "\"/credentials/migrate-encryption\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMigrateEncryptionEndpointCredentialsMigrateEncryptionPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMigrateEncryptionEndpointCredentialsMigrateEncryptionPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
