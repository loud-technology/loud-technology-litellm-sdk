...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class ToolsClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_DeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_DeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_DeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteSecurityRequirement0,
            };
        partial void PrepareDeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string toolName,
            ref string? teamId,
            ref string? keyHash);
        partial void PrepareDeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string toolName,
            string? teamId,
            string? keyHash);
        partial void ProcessDeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> DeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteAsync(
            string toolName,
        ...
        {
            var __response = await DeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteAsResponseAsync(
                toolName: toolName,
                teamId: teamId,
                keyHash: keyHash,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> DeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteAsResponseAsync(
            string toolName,
            string? teamId = default,
            string? keyHash = default,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteSecurityRequirements,
                operationName: "DeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: $"/v1/tool/{toolName}/overrides",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteToolPolicyOverrideV1ToolToolNameOverridesDelete",
                                methodName: "DeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteAsync",
                                pathTemplate: "$\"/v1/tool/{toolName}/overrides\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteToolPolicyOverrideV1ToolToolNameOverridesDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
