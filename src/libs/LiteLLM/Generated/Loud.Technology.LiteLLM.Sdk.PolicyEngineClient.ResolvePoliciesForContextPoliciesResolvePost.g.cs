...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class PolicyEngineClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_ResolvePoliciesForContextPoliciesResolvePostSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_ResolvePoliciesForContextPoliciesResolvePostSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_ResolvePoliciesForContextPoliciesResolvePostSecurityRequirement0,
            };
        partial void PrepareResolvePoliciesForContextPoliciesResolvePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? forceSync,
            global::Loud.Technology.LiteLLM.Sdk.PolicyResolveRequest request);
        partial void PrepareResolvePoliciesForContextPoliciesResolvePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? forceSync,
            global::Loud.Technology.LiteLLM.Sdk.PolicyResolveRequest request);
        partial void ProcessResolvePoliciesForContextPoliciesResolvePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessResolvePoliciesForContextPoliciesResolvePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.PolicyResolveResponse> ResolvePoliciesForContextPoliciesResolvePostAsync(
        ...
        {
            var __response = await ResolvePoliciesForContextPoliciesResolvePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.PolicyResolveResponse>> ResolvePoliciesForContextPoliciesResolvePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareResolvePoliciesForContextPoliciesResolvePostArguments(
                httpClient: HttpClient,
                forceSync: ref forceSync,
                request: request);


            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_ResolvePoliciesForContextPoliciesResolvePostSecurityRequirements,
                operationName: "ResolvePoliciesForContextPoliciesResolvePostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("force_sync", forceSync?.ToString().ToLowerInvariant())
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareResolvePoliciesForContextPoliciesResolvePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ResolvePoliciesForContextPoliciesResolvePost",
                                methodName: "ResolvePoliciesForContextPoliciesResolvePostAsync",
                                pathTemplate: "\"/policies/resolve\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessResolvePoliciesForContextPoliciesResolvePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessResolvePoliciesForContextPoliciesResolvePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Loud.Technology.LiteLLM.Sdk.PolicyResolveResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<global::Loud.Technology.LiteLLM.Sdk.PolicyResolveResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Loud.Technology.LiteLLM.Sdk.PolicyResolveResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.PolicyResolveResponse> ResolvePoliciesForContextPoliciesResolvePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Loud.Technology.LiteLLM.Sdk.PolicyResolveRequest
            {
                KeyAlias = keyAlias,
                Model = model,
                Tags = tags,
            ...
            return await ResolvePoliciesForContextPoliciesResolvePostAsync(
                forceSync: forceSync,
                request: __request,
                requestOptions: requestOptions,
