...
namespace Loud.Technology.LiteLLM.Sdk
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement s_GetFileContentProviderV1FilesFileIdContentGetSecurityRequirement0 =
        ...
        private static readonly global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[] s_GetFileContentProviderV1FilesFileIdContentGetSecurityRequirements =
            new global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityRequirement[]
            {                s_GetFileContentProviderV1FilesFileIdContentGetSecurityRequirement0,
            };
        partial void PrepareGetFileContentProviderV1FilesFileIdContentGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string fileId,
            ref string? provider);
        partial void PrepareGetFileContentProviderV1FilesFileIdContentGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string fileId,
            string? provider);
        partial void ProcessGetFileContentProviderV1FilesFileIdContentGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetFileContentProviderV1FilesFileIdContentGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// This is the equivalent of GET https://api.openai.com/v1/files/{file_id}/content<br/>
        /// Supports Identical Params as: https://platform.openai.com/docs/api-reference/files/retrieve-contents<br/>
        /// Example Curl<br/>
        /// ```<br/>
        /// curl http://localhost:4000/v1/files/file-abc123/content         -H "Authorization: Bearer sk-1234"<br/>
        /// ```
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<string> GetFileContentProviderV1FilesFileIdContentGetAsync(
            string fileId,
            string? provider,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetFileContentProviderV1FilesFileIdContentGetAsResponseAsync(
                fileId: fileId,
                provider: provider,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Loud.Technology.LiteLLM.Sdk.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Loud.Technology.LiteLLM.Sdk.AutoSDKHttpResponse<string>> GetFileContentProviderV1FilesFileIdContentGetAsResponseAsync(
            string fileId,
            string? provider,
            global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFileContentProviderV1FilesFileIdContentGetArguments(
            ...
            var __authorizations = global::Loud.Technology.LiteLLM.Sdk.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetFileContentProviderV1FilesFileIdContentGetSecurityRequirements,
                operationName: "GetFileContentProviderV1FilesFileIdContentGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Loud.Technology.LiteLLM.Sdk.PathBuilder(
                                path: $"/{provider}/v1/files/{fileId}/content",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetFileContentProviderV1FilesFileIdContentGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetFileContentProviderV1FilesFileIdContentGet",
                                methodName: "GetFileContentProviderV1FilesFileIdContentGetAsync",
                                pathTemplate: "$\"/{provider}/v1/files/{fileId}/content\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetFileContentProviderV1FilesFileIdContentGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Loud.Technology.LiteLLM.Sdk.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFileContentProviderV1FilesFileIdContentGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
